function start() {
    ...
    function draw() {
        ...
        // Translate slider values to angles in the [-2pi,2pi] interval
        var angle1 = slider1.value*0.01*(2*Math.PI);
        var angle2 = slider2.value*0.01*(2*Math.PI);
    
        // Circle around the y-axis
        var eye = [300.0*Math.sin(angle1),200.0,300.0*Math.cos(angle1)];
        var target = [0,0,0];
        var up = [0,200,0];
    
        var tModel = mat4.create();
        mat4.fromScaling(tModel,[100,100,100]);
        mat4.rotate(tModel,tModel,angle2,[2,2,2]);
